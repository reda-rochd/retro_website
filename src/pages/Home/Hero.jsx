...
export default function Hero() {
	return (
		<section className="relative text-center text-white bg-cover bg-center max-w-4xl inset-0 mx-auto">
			<div className="absolute w-[var(--content-width)] flex justify-between px-5 pt-3 inset-0 mx-auto">
				<span>LOGO</span>
				<span>1337</span>
